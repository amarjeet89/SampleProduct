...
public class EditProfileFragment extends Fragment implements View.OnClickListener, ImagePickerFragment.DialogCallBack {
                    ...
                    try {
                        ...
                        if(obj.getString("status").equals("success")){
                            ...
                            if(sellerObject.has("_id")){
                                ...
                                String addressValuue = sellerAddressObject.getString("address");
                                name.setText(title);
                                address.setText(addressValuue);
    ...
    private void addSellerData(){
        ...
        try {
            ...
            obj.put("contacts", new JSONArray().put(mobileNo.getText().toString()));
            obj.put("description", aboutMe.getText().toString());
            JSONObject adddressJsonObject = new JSONObject();
            adddressJsonObject.put("address",address.getText().toString());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(requestCode==RESULT_LOAD_IMG && data !=null){
            ...
            final Bitmap bitmap = BitmapFactory.decodeFile(imageUri.getPath(),
                    options);
            MediaUtils.decodeFile(imageUri.getPath(), bitmap.getWidth() - 20,
                    bitmap.getHeight() - 30);
